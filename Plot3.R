...
PlotQ3<-ggplot(NEIBAL, aes(x=factor(year), y= Emissions))+geom_bar(stat='identity')+ facet_grid(. ~ type)+labs(title = 'Emissions per source between 1999 and 2008 in Baltimore')+labs(x= 'year', y = 'Emissions (tons)')
